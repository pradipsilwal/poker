...
func TestIsStraight(t *testing.T) {
	tests := []testData{
		{list: []int64{2, 2, 3, 4, 4}, wantHigh: 4, wantIsStraight: false},
		{list: []int64{3, 5, 6, 7, 8}, wantHigh: 8, wantIsStraight: false},
		{list: []int64{2, 3, 4, 5, 14}, wantHigh: 14, wantIsStraight: false},
		{list: []int64{5, 6, 7, 8, 9}, wantHigh: 9, wantIsStraight: true},
